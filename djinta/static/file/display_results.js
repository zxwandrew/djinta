function SaveDrawing() {	
	...
	Dajaxice.drawings.save_drawing(drawingsaved, {
		'form':AllPartsJSON
	})
...
function send_form() {
				...
				//alert(AllPartsJSON);
	$(".Alerts").replaceWith('<div class="Alerts"><center>Please Wait For the Calculations to Finish<center></div>');
	$(".Alerts").show("slow");
